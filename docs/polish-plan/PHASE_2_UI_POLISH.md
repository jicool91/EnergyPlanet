...
- [ ] Задача 2.1 завершена - OfflineSummaryModal не обрезана
- [ ] Задача 2.2 завершена - LeaderboardPanel красиво на 320px
- [ ] Задача 2.3 завершена - BuildingCard красиво на узких экранах
- [ ] Задача 2.4 завершена (optional) - Toast UI улучшена
...
**Версия:** 1.0 | **Дата:** 2025-10-24 | **Статус:** 🟡 Высокий приоритет - ждёт реализации
