    ...
    extend: {
      colors: {
        ...
        layer: {
          ...
          'overlay-strong': colorVar('--layer-overlay-strong'),
          'overlay-medium': colorVar('--layer-overlay-medium'),
          'overlay-soft': colorVar('--layer-overlay-soft'),
          'overlay-faint': colorVar('--layer-overlay-faint'),
          'overlay-ghost': colorVar('--layer-overlay-ghost'),
          'overlay-ghost-strong': colorVar('--layer-overlay-ghost-strong'),
          'overlay-ghost-soft': colorVar('--layer-overlay-ghost-soft'),
        },
        text: {
        ...
        state: {
          ...
          'accent-pill': colorVar('--state-accent-pill'),
          'accent-pill-soft': colorVar('--state-accent-pill-soft'),
          'success-pill': colorVar('--state-success-pill'),
          'success-pill-strong': colorVar('--state-success-pill-strong'),
          'cyan-pill-soft': colorVar('--state-cyan-pill-soft'),
          'cyan-pill-strong': colorVar('--state-cyan-pill-strong'),
          'cyan-pill-glow': colorVar('--state-cyan-pill-glow'),
        },
        tag: {
